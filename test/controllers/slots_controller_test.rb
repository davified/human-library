...
class SlotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slot" do
    assert_difference('Slot.count') do
      post slots_url, params: { slot: { end_time: @slot.end_time, event_id: @slot.event_id, is_available: @slot.is_available, pax_capacity: @slot.pax_capacity, start_time: @slot.start_time } }
    end
  ...
  test "should update slot" do
    patch slot_url(@slot), params: { slot: { end_time: @slot.end_time, event_id: @slot.event_id, is_available: @slot.is_available, pax_capacity: @slot.pax_capacity, start_time: @slot.start_time } }
